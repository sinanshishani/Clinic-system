...
namespace EClinic.Framework.Repositories
{
        ...
        where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        /// </summary>
        public virtual ApplicationDbContext Context { get; }
        ...
        public override Task InsertAllAsync(IEnumerable<TEntity> entities)
        {
            return Table.AddRangeAsync(entities);
        }

        public override void InsertAll(IEnumerable<TEntity> entities)
        {
